...
async def status(interaction: discord.Interaction):
    if bot_online == True:
        ...
        embed.add_field(name="Video Responses", value=status_report_data['video_responses'], inline=True)
        embed.add_field(name="Music Responses", value=status_report_data['music_responses'], inline=True)
        embed.add_field(name="Debug Logging", value=status_report_data['logging_mode'], inline=True)
        ...
        embed.add_field(name="AI Inference Server Status", value=status_report_data['inference_server_status'], inline=True)
